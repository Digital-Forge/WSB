    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraPerks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumberRoom = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CountOld = table.Column<int>(nullable: false),
                    CountChild = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExtraPerkId = table.Column<int>(nullable: false),
                    RoomReservationId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerksToRooms", x => new { x.RoomReservationId, x.ExtraPerkId });
                    table.ForeignKey(
                        name: "FK_PerksToRooms_ExtraPerks_ExtraPerkId",
                        column: x => x.ExtraPerkId,
                        principalTable: "ExtraPerks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PerksToRooms_RoomReservations_RoomReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerksToRooms_ExtraPerkId",
                table: "PerksToRooms",
                column: "ExtraPerkId");
